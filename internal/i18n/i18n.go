...
var translations = map[string]map[string]string{
	"en": {
		...
		"hottest.title":       "Hottest Repositories (%s mode)",
		"hottest.tip":         "Use --mode velocity to rank all repos by growth speed",
	...
	"ja": {
		...
		"hottest.title":       "急上昇リポジトリ (%sモード)",
		"hottest.tip":         "--mode velocity で全リポジトリを成長速度順に表示",
